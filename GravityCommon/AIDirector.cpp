    ...
    if (timeaccumulator.asSeconds() > 0.05)
    {
        ...
        for (auto ei : registeredentities)
        {
            ...
            case Behavior::State::BIRTH:
                ...
                //entities[ei].waypointpath.push_back(16);
                //entities[ei].waypointpath.push_back(17);
                //entities[ei].waypointpath.push_back(18);
                //entities[ei].waypointpath.push_back(19);
                //entities[ei].waypointpath.push_back(20);
                //entities[ei].waypointpath.push_back(21);
                //entities[ei].waypointpath.push_back(22);
                //entities[ei].waypointpath.push_back(23);
                //entities[ei].waypointpath.push_back(24);
            ...
            case Behavior::State::IDLE:
                entities[ei].behavior.state = Behavior::State::SEEKWAYPOINT;
                break;
            case Behavior::State::SEEKWAYPOINT: {
                // Continue seeking waypoint
                sf::Vector2f gap = waypoints[entities[ei].waypointpath[entities[ei].seekwaypoint]].location - entities[ei].proto.body.pos;
                ...
                else if (dist > 0)
                {
                    ...
                    if (vec::dot(ngap, physics::upVector(entities[ei].proto.body.angle)) > 0.0f)
                    {
                ...
                break;
            case Behavior::State::SEEKENTITY:
                // Continue seeking entity
                break;
